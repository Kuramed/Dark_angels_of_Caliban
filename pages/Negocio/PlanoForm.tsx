            ...
            <form onSubmit={handleSubmit} className="card p-4 mt-3 shadow-sm">
                ...
                <div className="row">
                    <div className="col-md-6 mb-3">
                        ...
                        <input type="number" step="0.01" className="form-control" value={formData.preco}
                            onChange={e => setFormData({ ...formData, preco: Number(e.target.value) })} required />
                    </div>
                    <div className="col-md-6 mb-3">
                        <label className="form-label">Duração (Meses)</label>
                        <input type="number" className="form-control" value={formData.duracaoMeses}
                            onChange={e => setFormData({ ...formData, duracaoMeses: Number(e.target.value) })} required />
                    </div>
                </div>
                <div className="mb-3">
                ...
                <div className="d-flex gap-2">
                    <button type="submit" className="btn btn-success">Guardar Plano</button>
                    <button type="button" className="btn btn-secondary" onClick={() => navigate('/planos')}>Cancelar</button>
                </div>
            </form>
        </div>
    );
