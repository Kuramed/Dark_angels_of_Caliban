        ...
        <div className="container mt-4">
            ...
            <form onSubmit={handleSubmit} className="card p-4 mt-3 shadow-sm">
                ...
                <div className="mb-3">
                    ...
                    <textarea className="form-control" rows={4} value={formData.descricao}
                        onChange={e => setFormData({ ...formData, descricao: e.target.value })} required />
                </div>
                <div className="d-flex gap-2">
                    <button type="submit" className="btn btn-success">Guardar Trilha</button>
                    <button type="button" className="btn btn-secondary" onClick={() => navigate('/trilhas')}>Cancelar</button>
                </div>
            </form>
        </div>
    );
