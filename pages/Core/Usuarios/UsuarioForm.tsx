...
export function UsuarioForm() {
    ...
    const handleSubmit = async (e: FormEvent) => {
        e.preventDefault();
        // Nota: O UsuarioService.salvar precisa ser implementado no core.service.ts seguindo o mesmo molde da Categoria
            ...
            <form onSubmit={handleSubmit} className="card p-4 mt-3 shadow-sm">
                <div className="row">
                    <div className="col-md-6 mb-3">
                        ...
                        <input type="text" className="form-control" value={formData.nomeCompleto}
                            onChange={e => setFormData({ ...formData, nomeCompleto: e.target.value })} required />
                    </div>
                ...
                <div className="row">
                    <div className="col-md-6 mb-3">
                        ...
                        <input type="password" className="form-control" value={formData.senhaHash}
                            onChange={e => setFormData({ ...formData, senhaHash: e.target.value })} required={!id} />
                    </div>
                ...
                <div className="d-flex gap-2 mt-2">
                    <button type="submit" className="btn btn-success">Guardar Utilizador</button>
