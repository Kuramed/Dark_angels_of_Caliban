...
export function AvaliacaoTable() {
    ...
    useEffect(() => {
        // Por simplificação, vamos assumir que o listarPorCurso sem ID lista todas para o painel admin
    ...
    return (
        <div className="container mt-4">
            <div className="d-flex justify-content-between mb-3">
                ...
                <Link to="/avaliacoes/novo" className="btn btn-primary">Nova Avaliação</Link>
            </div>
