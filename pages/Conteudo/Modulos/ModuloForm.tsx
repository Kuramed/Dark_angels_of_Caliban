...
export function ModuloForm() {
    ...
    // Para preencher o Dropdown de Cursos
        ...
        <div className="container mt-4">
            ...
            <form onSubmit={handleSubmit} className="card p-4 mt-3">
                ...
                <div className="d-flex gap-2 mt-3">
                    <button type="submit" className="btn btn-success">Guardar Módulo</button>
                    <button type="button" className="btn btn-secondary" onClick={() => navigate('/modulos')}>Cancelar</button>
                </div>
            </form>
        </div>
    );
